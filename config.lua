-- The OTX Server Config
	...
	-- Owner Data
	ownerName = "Dbo Gameplayer"
	ownerEmail = "dbogameplayer@hotmail.com"
	url = ""
	location = "Brazil"

	-- Messages
	motd = "Welcome to the Wodbo Max!"
	serverName = "Wodbo Max"
	loginMessage = "Welcome to Wodbo Max!"
	...
	newPlayerSpawnPosX = 99
	newPlayerSpawnPosY = 188
	...
	fragsSecondToBlackSkull = 80
	fragsThirdToBlackSkull = 150
	...
	fragsToBanishment = 30
	fragsSecondToBanishment = 80
	fragsThirdToBanishment = 370
	...
	antiPushDelay = 450 --// default is 3000 (3 seconds)
	...
	timeBetweenCustomActions = 250
	checkCorpseOwner = false
	hotkeyAimbotEnabled = true
	maximumDoorLevel = 3100
	tradeLimit = 100
